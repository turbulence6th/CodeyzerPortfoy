...
interface HoldingsListProps {
  ...
  categoryCharts?: CategoryChart[]; // Kategori grafikleri bilgisi
...
export const HoldingsList: React.FC<HoldingsListProps> = ({
  ...
  // Bir varlığın hangi kategorilerde olduğunu bulma fonksiyonu
  ...
  }> = ({ holding, priceData, onEdit, onDelete, isLast }) => {
      ...
      >
        ...
        <Box
          sx={{
            ...
            pr: { xs: 0.75, sm: 2 },
            gap: { xs: 0.5, sm: 0 },
            transform: swiped ? `translateX(-${TRAY_WIDTH}px)` : 'translateX(0)',
